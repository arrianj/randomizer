...
def generator():
    ...
    raw_num_1 = date_num * int(temp_num * date_num) * int(wind_num * date_num) * int(date_num * wind_num ** temp_num)
    raw_num_2 = date_num * int(temp_num * date_num) * int(wind_num * temp_num) * int(date_num * wind_num ** temp_num)
    raw_num_3 = date_num * int(temp_num * wind_num) * int(wind_num * date_num) * int(date_num * wind_num ** temp_num)
    raw_num_4 = date_num * int(date_num * wind_num) * int(wind_num * date_num) * int(temp_num * wind_num ** temp_num)
